...
import {getMergedTasks} from 'app/components/onboardingWizard/getOnboardingTasks';
...
class OnboardingStatus extends React.Component<Props> {
  ...
  render() {
    ...
    const remaining = allDisplayedTasks.length - doneTasks.length;
        ...
        <Container onClick={onShowPanel} isActive={isActive}>
          ...
          {!collapsed && (
            <div>
              ...
              <Remaining>
                {tct('[remaining] Remaining tasks', {remaining})}
