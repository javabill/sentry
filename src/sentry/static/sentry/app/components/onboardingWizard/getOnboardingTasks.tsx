...
import EventWaiter from 'app/components/eventWaiter';
...
export function getOnboardingTasks(
  ...
  return [
    ...
    },
    {
      ...
      description: t('Install the appropraite Sentry SDK for application'),
      ...
      SupplementComponent: withProjects(
        withApi(({api, task, projects, completeTask}: FirstEventWaiterProps) =>
          projects.length > 0 &&
          ...
          !task.completionSeen ? (
            <EventWaiter
              ...
              organization={organization}
              project={projects[0]}
              onIssueRecieved={() => !taskIsDone(task) && completeTask()}
            >
